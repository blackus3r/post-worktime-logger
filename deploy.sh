...
# main config
PLUGINSLUG="post-worktime-logger"
CURRENTDIR=`pwd`
MAINFILE="post-worktime-logger.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/post-worktime-logger/" # Remote SVN repo on wordpress.org, with no trailing slash
